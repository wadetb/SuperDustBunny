...
void gxInit( gxDisplayType disp )
{
	...
	gxDev->SetSamplerState(0, D3DSAMP_MINFILTER, D3DTEXF_LINEAR);
	gxDev->SetSamplerState(0, D3DSAMP_MAGFILTER, D3DTEXF_LINEAR);
	gxDev->SetSamplerState(0, D3DSAMP_MIPFILTER, D3DTEXF_LINEAR);
